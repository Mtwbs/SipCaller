...
/**
 * A Participant2 represents a peer in an RTPSession. Based on the information stored on 
 * these objects, packets are processed and statistics generated for RTCP.
 */
public class Participant2 {
	/** Whether the Participant2 is unexpected, e.g. arrived through unicast with SDES */
	...
	/** SSRC of Participant2 */
	protected long ssrc = -1;
	/** SDES CNAME */
	protected String cname = null;
	/** SDES The Participant2's real name */
	protected String name = null;
	/** SDES The Participant2's email */
	protected String email = null;
	/** SDES The Participant2's phone number */
	protected String phone = null;
	/** SDES The Participant2's location*/
	protected String loc = null;
	/** SDES The tool the Participant2s is using */
	...
	/** UNIX time when a BYE was received from this Participant2, for pruning */
	protected long timestampBYE = -1;	// The user said BYE at this time
	
	/** Store the packets received from this Participant2 */
	protected PktBuffer pktBuffer = null;

	/** UNIX time of last RTP packet, to check whether this Participant2 has sent anything recently */
	protected long lastRtpPkt = -1; //Time of last RTP packet
	/** UNIX time of last RTCP packet, to check whether this Participant2 has sent anything recently */
	protected long lastRtcpPkt = -1; //Time of last RTCP packet
	/** UNIX time this Participant2 was added by application, to check whether we ever heard back */
	protected long addedByApp = -1; //Time the Participant2 was added by application
	...
	/**
	 * Create a basic Participant2. If this is a <b>unicast</b> session you must provide network address (ipv4 or ipv6) and ports for RTP and RTCP, 
	 * as well as a cname for this contact. These things should be negotiated through SIP or a similar protocol.
	 * 
	 * jlibrtp will listen for RTCP packets to obtain a matching SSRC for this Participant2, based on cname.
	 ...
	 */
	public Participant2(String networkAddress, int rtpPort, int rtcpPort) {
		if(RTPSession.rtpDebugLevel > 6) {
			System.out.println("Creating new Participant2: " + networkAddress);
		}
	...
	protected Participant2(InetSocketAddress rtpAdr, InetSocketAddress rtcpAdr, long SSRC) {
	...
	/**
	 * RTP Address registered with this Participant2.
	 * 
	 * @return address of Participant2
	 */
	...
	/**
	 * RTCP Address registered with this Participant2.
	 * 
	 * @return address of Participant2
	 */
	...
	/**
	 * InetSocketAddress this Participant2 has used to
	 * send us RTP packets.
	 * 
	 * @return address of Participant2
	 */
	...
	/**
	 * CNAME registered for this Participant2.
	 * 
	 * @return the cname
	 */
	...
	/**
	 * NAME registered for this Participant2.
	 * 
	 * @return the name
	 */
	...
	/**
	 * EMAIL registered for this Participant2.
	 * 
	...
	/**
	 * PHONE registered for this Participant2.
	 * 
	...
	/**
	 * LOCATION registered for this Participant2.
	 * 
	 * @return the location
	 */
	...
	/**
	 * NOTE registered for this Participant2.
	 * 
	 * @return the note
	 */
	...
	/**
	 * PRIVATE something registered for this Participant2.
	 * 
	...
	/**
	 * TOOL something registered for this Participant2.
	 * 
	 * @return the tool
	 */
	...
	/**
	 * SSRC for Participant2, determined through RTCP SDES
	 * 
	...
	/** 
	 * Updates the Participant2 with information for receiver reports.
	 * 
	...
	public void debugPrint() {
		System.out.print(" Participant2.debugPrint() SSRC:"+this.ssrc+" CNAME:"+this.cname);
